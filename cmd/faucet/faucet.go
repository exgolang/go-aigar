// Copyright 2017 The go-aigar Authors
...
import (
	...
	"github.com/exgolang/go-aigar/ethclient"
...
func (f *faucet) apiHandler(conn *websocket.Conn) {
	...
	for {
		...
		default:
			err = errors.New("Something funky happened, please open an issue at https://github.com/exgolang/go-aigar/issues")
		}
		if err != nil {
			if err = sendError(conn, err); err != nil {
