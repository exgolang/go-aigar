...
//
// Detailed usage document and tutorial available on the go-aigar Wiki page:
// https://github.com/exgolang/go-aigar/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
